...
public class VentaController implements Initializable{
    		...
    		if(dateFecha.getValue()!=null){
    			if(!mfm.verificarExistenciaVenta(codigo)){
        			...
        			if(clienteVenta!=null){
        				aplicacion.mostrarVentanaInformacionCliente(event, codigo, ""+dateFecha.getValue(), clienteVenta);
        			}else{
        				mostrarMensaje("Gestión ventas", "Proceso incompleto", "La identificación no corresponde a ningun cliente registrado", AlertType.INFORMATION);
        			}
    			}else{
    				mostrarMensaje("Gestión ventas", "Proceso incompleto", "Ya existe una venta con ese codigo", AlertType.INFORMATION);

    			}
    		}else{
				mostrarMensaje("Gestión ventas", "Proceso incompleto", "Por favor seleccionar la fecha de la venta", AlertType.INFORMATION);
    ...
    private boolean validarCamposTexto(String codigo, String identificacion) {
    	...
    	mostrarMensaje("Gestión ventas", "Proceso incompleto", msj, AlertType.INFORMATION);
		return false;
	}
