...
public class ModelFactoryController {
	...
	private void inicializarDatos() {
		...
		Cliente cliente2 = new ClienteJuridico("Miguel", "Marin", "1090272281", "3192784589",
				"calle", "04");
	...
	/**
	 * Este metodo es para comprar un producto
	 * @param venta
	 * @param producto
	 * @param cantidad
	 * @return
	...
	public void actualizarProductoEnvasado(String nombre, String codigo, int cantidadExistencia, Double valorUnitario,
			String descripcion, PaisOrigen paisOrigen, double pesoEnvasado, String fechaEnvasado) throws ProductoException {
		// TODO Auto-generated method stub
		almacen.crearProductoEnvasado(codigo, nombre, descripcion, valorUnitario, cantidadExistencia, fechaEnvasado, pesoEnvasado, paisOrigen);
	}
